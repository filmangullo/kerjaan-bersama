    ...
    <div class="container">
        ...
        <div class="inner_sec_grids_info_w3ls">
            <div class="w3layouts_mail_grid row">
                <form action="{{route("deskripsi.store", $pertemuan->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-2"></div>
                    <div class="col-md-8 offset-md-2">
                        <textarea id="text" class="form-control" name="text" rows="10" cols="50"></textarea>
